      ...
      <SignIn 
        appearance={{
          elements: {
            ...
            formButtonPrimary: "bg-primary hover:bg-primary-dark text-black font-medium",
            formFieldInput: "bg-surface border border-border text-text focus:border-primary",
            formFieldLabel: "text-text-light",
            footerActionLink: "text-primary hover:text-primary-light",
            dividerLine: "bg-border",
            dividerText: "text-text-light",
            socialButtonsBlockButton: "bg-surface border border-border text-text hover:bg-surface-light",
